...
export default function SeoStorytelling({ locale = 'en' }) {
  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#0E0804]">
      <div className={`max-w-6xl mx-auto ${isRtl ? 'text-right' : 'text-left'}`} dir={isRtl ? 'rtl' : 'ltr'}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          
          {/* Main Story Block (Bento Large) */}
          <div className="col-span-1 lg:col-span-7 bg-[#140D07] rounded-3xl p-8 sm:p-12 border border-copper/20 relative overflow-hidden group hover:border-copper/40 transition-colors shadow-2xl">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-cream leading-tight" style={{ fontFamily: "var(--font-cairo)" }}>
                {t.storyTitle}
              </h2>
          ...
          {/* Image Block 1 */}
          <div className="col-span-1 lg:col-span-5 relative min-h-[320px] rounded-3xl overflow-hidden border border-teal-dim/30 shadow-2xl">
            <Image 
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0E0804]/80 to-transparent"></div>
          </div>

          {/* Image Block 2 */}
          <div className="col-span-1 lg:col-span-4 relative min-h-[300px] rounded-3xl overflow-hidden border border-gold/20 shadow-2xl">
            <Image 
          ...
          <div className="col-span-1 lg:col-span-8 bg-gradient-to-br from-[#140D07] to-[#0a0603] rounded-3xl p-8 sm:p-10 border border-teal-dim/30 relative overflow-hidden group hover:border-gold/30 transition-colors shadow-2xl">
