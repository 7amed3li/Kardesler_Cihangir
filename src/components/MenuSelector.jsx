...
export default function MenuSelector({ categories, activeCategory, setActiveCategory }) {
  ...
  return (
    <div className="w-full bg-[#0a0a0a] overflow-x-auto no-scrollbar pt-2 pb-0">
      <div className="flex items-center gap-8 px-6 min-w-max">
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              <span className={`relative z-10 block ${isActive ? "text-white" : "text-gray-500 hover:text-gray-300"} transition-colors duration-300`}>
