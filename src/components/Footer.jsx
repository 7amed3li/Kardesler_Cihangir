        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex items-center gap-4 mb-6">
              <a href="https://www.instagram.com/kardeslerkebapcihangir/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-ink border border-teal-dim/20 flex items-center justify-center text-cream-dim hover:text-copper hover:border-copper transition-all duration-300">
              ...
              <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-full bg-ink border border-teal-dim/20 flex items-center justify-center text-cream-dim hover:text-copper hover:border-copper transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
