...
export const metadata = {
  ...
  keywords: [
    "лучший кебаб в таксиме",
    "халяльный ресторан стамбул",
    "где поесть в таксиме",
    "лучшая турецкая еда бейоглу",
    "настоящий адана кебаб",
    "кебаб возле площади таксим",
    "турецкая пицца лахмаджун таксим",
    "рестораны возле и истикляль",
    "лучшие грили в стамбуле",
    "kardesler cihangir кебаб",
    "халяль мясо стамбул",
    "рестораны галатапорт",
    "турецкий завтрак таксим",
    "традиционный турецкий завтрак",
    "лучший завтрак в стамбуле",
    "менемен стамбул",
    "яичница с суджуком",
    "недорогой завтрак таксим",
    "адана кебаб",
    "урфа кебаб",
    "бейти кебаб",
