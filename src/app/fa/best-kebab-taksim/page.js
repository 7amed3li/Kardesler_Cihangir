...
export const metadata = {
  ...
  keywords: [
    "بهترین کباب تقسیم استانبول",
    "رستوران حلال تقسیم",
    "رستوران کاردشلر جهانگیر ۱۹۹۸",
    "کباب آدانا زغالی استانبول",
    "پیده تنوری بی اوغلو",
      ...
      <section className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center justify-center pt-24 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 relative z-10">
          ...
          >
            ...
            روی <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-amber-200 to-copper">زغال طبیعی چوب بلوط</span> نزدیک تقسیم
          </h1>
