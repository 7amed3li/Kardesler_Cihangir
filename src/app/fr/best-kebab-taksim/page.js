...
export const metadata = {
  ...
  keywords: [
    ...
    "restaurant halal istanbul",
    "où manger à taksim",
    "grillades turques authentiques",
    "meilleur lahmacun beyoglu",
    "restaurant traditionnel près de istiklal",
    "kebab cuit au feu de bois",
    "restaurant familial taksim",
    "kebab adana istanbul",
    "meilleure cuisine turque",
    "kebab de viande halal",
    "petit déjeuner turc taksim",
    "petit déjeuner traditionnel istanbul",
    "meilleur petit déjeuner istanbul",
    "menemen taksim",
    "oeufs au sucuk",
    "petit déjeuner pas cher",
    "adana kebab",
    "urfa kebab",
    "soupe aux lentilles turque",
