...
export const metadata = {
  ...
  keywords: [
    "أفضل كباب في تقسيم",
    "كباب حلال في اسطنبول",
    "مطاعم قريبة من ميدان تقسيم",
    "أفضل مطعم مشويات في بيوغلو",
    "مشاوي عثمانية على الفحم",
    "لحمجون تركي في تقسيم",
    "أفضل بيدا في جيهانكير",
    "مطعم تركي عائلي تقسيم",
    "أين أكل كباب في اسطنبول",
    "مطاعم شارع الاستقلال",
    "مطاعم قريبة من برج غلطة",
    "أفضل شاورما و كباب اسطنبول",
    "لحم حلال 100% تقسيم",
    "اسكندر كباب تقسيم",
    "كباب أضنة في اسطنبول",
    "مطعم كارديشلر جيهانكير",
    "أكل تركي أصيل",
    "أفضل مطاعم اسطنبول 2024",
    "مطاعم رخيصة وممتازة في تقسيم",
    "مشويات تركية تقسيم",
    "كباب تركي على أصوله",
    "مطاعم تفتح لوقت متأخر في تقسيم",
    "أشهر مطاعم الكباب في تركيا",
    "دليل مطاعم اسطنبول",
    "أفضل لحم بعجين في اسطنبول",
    "مطاعم قريبة من غلطة بورت",
    "أفضل كبابجي في اسطنبول",
    "اسعار المطاعم في تقسيم",
    "مطعم كباب ممتاز ورخيص",
    "وجبات سريعة تركية تقسيم",
    "فطور تركي تقسيم",
    "إفطار تركي تقليدي",
    "أفضل فطور في اسطنبول",
    "مينيمين تركي",
    "بيض بالسجق",
    "فطور بسعر مميز في تقسيم",
    "فطور عائلي اسطنبول",
    "بوريك بالجبنة",
    "فطور تركي جيهانكير",
    "كباب أضنة",
    ...
    "كباب بيتي",
    "شوربة عدس تركية",
    "افطار تركي رخيص وممتاز",
    "افضل فطور في اسطنبول تقسيم",
    "لحم بعجين تركي",
    "لحم بعجين في تقسيم",
    "كبة تركية",
    "كبة مقلية اسطنبول",
