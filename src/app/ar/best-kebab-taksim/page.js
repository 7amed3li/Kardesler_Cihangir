...
export default function BestKebabTaksimArabicPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0E0804] text-cream selection:bg-copper selection:text-white" dir="rtl">
      ...
      <section className="relative min-h-[85vh] sm:min-h-[90vh] flex items-center justify-center pt-24 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 relative z-10">
          ...
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gold/10 border border-gold/30 text-gold text-[11px] sm:text-xs font-semibold uppercase tracking-[0.1em]">
            ...
            <span>تأسس عام 1998 • في قلب حي جيهانكير التاريخي، بيوغلو</span>
          </div>
          ...
          >
            ...
            على <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-amber-200 to-copper">جمر السنديان الطبيعي</span> قرب تقسيم
          </h1>
      ...
      {/* ── NEW SEO CONTENT SECTION (ARABIC) ── */}
      <section className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#0E0804]" dir="rtl">
        <article className="max-w-4xl mx-auto space-y-16 text-right">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-copper/10 border border-copper/30 text-copper text-xs font-semibold uppercase tracking-wider mb-2">
              <Compass size={14} />
              <span>تراثنا العريق</span>
            </div>
            <h2 className="text-2xl sm:text-4xl font-black text-cream leading-tight" style={{ fontFamily: "var(--font-cairo)" }}>
              قصة كارديشلر جيهانكير — منذ 1998
            </h2>
            <div className="space-y-4 text-cream-dim/85 text-sm sm:text-base leading-relaxed font-light">
              <p>
                على بُعد مسافة قصيرة (5 دقائق سيراً على الأقدام) من صخب ميدان تقسيم، يقع حي جيهانكير، الحي الأكثر عراقة وفناً في منطقة بيوغلو. وهنا، وسط الشوارع المتعرجة التي يفضلها الفنانون والكتّاب وعشاق الطعام الأصيل، تأسس مطعم كارديشلر كباب في عام 1998.
              </p>
              <p>
                على مدى أكثر من عقدين من الزمان، بقينا أوفياء للمبادئ الأساسية للمطبخ التركي الأصيل. وبينما شهدت المناطق المحيطة بتقسيم وشارع الاستقلال افتتاح وإغلاق عدد لا يحصى من المطاعم السياحية، صمد مطعم كارديشلر جيهانكير كمعقل للنكهة المحلية الأصيلة. نحن لسنا مجرد مطعم؛ نحن تقليد عائلي مكرس للحفاظ على التراث الغني للشواء الأناضولي والخبز في الأفران الحجرية في قلب إسطنبول.
              </p>
              <p>
                عندما تبحث عن أفضل كباب في تقسيم، فأنت على الأرجح تبحث عن أكثر من مجرد وجبة — أنت تبحث عن تجربة متجذرة في الأصالة. إن التزامنا بالمكونات عالية الجودة، وطرق التحضير التقليدية، وكرم الضيافة التركية الدافئة قد جعلنا وجهة مفضلة لكل من سكان جيهانكير المحليين والمسافرين الباحثين عن الطعم الحقيقي من جميع أنحاء العالم.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-copper/10 border border-copper/30 text-copper text-xs font-semibold uppercase tracking-wider mb-2">
              <Flame size={14} />
              <span>حرفية التحضير</span>
            </div>
            <h2 className="text-2xl sm:text-4xl font-black text-cream leading-tight" style={{ fontFamily: "var(--font-cairo)" }}>
              حرفتنا: جمر السنديان والفرن الحجري بدرجة 450 مئوية
            </h2>
            <div className="space-y-4 text-cream-dim/85 text-sm sm:text-base leading-relaxed font-light">
              <p>
                السر وراء الكباب التركي الذي لا يُنسى يكمن بالكامل في طريقة التحضير. في كارديشلر جيهانكير، لا نساوم على الجودة أبداً. نستخدم فقط لحوماً حلال طازجة 100% يومياً، ونرفض تماماً استخدام أي منتجات مجمدة.
              </p>
              <p>
                لا يزال طهاتنا المهرة (الأسطوات) يستخدمون السكين الهلالي الثقيل التقليدي، المعروف باسم "Zırh" (الساطور)، لفرم اللحم يدوياً. هذه التقنية الأناضولية الشاقة تحافظ على قوام وعصارة اللحم بطريقة لا يمكن للمفارم التجارية الحديثة مضاهاتها. بعد التحضير، يتم شواء الكباب ببطء على جمر السنديان الحقيقي، مما يشبعه بتلك النكهة المدخنة المميزة التي لا تقاوم.
              </p>
              <p>
                وبنفس القدر من الأهمية يأتي إتقاننا لتحضير العجين. فرننا الحجري التقليدي، الذي تشتعل فيه النيران بدرجة حرارة 450 مئوية، هو قلب قسم المخبوزات لدينا. سواء كانت القاعدة الرقيقة المقرمشة لـ "اللحمجون" أو القشرة المنتفخة والمحمصة لـ "البيدا" المخبوزة على الحطب، يتم خبز كل صنف طازجاً عند الطلب. الحرارة الشديدة للفرن الحجري تخلق التوازن المثالي بين السطح الخارجي المقرمش والداخل الطري الغني بالنكهات.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-cream leading-tight" style={{ fontFamily: "var(--font-cairo)" }}>
              ماذا تتذوق: كلاسيكيات الأناضول الأكثر طلباً
            </h2>
            <div className="space-y-4 text-cream-dim/85 text-sm sm:text-base leading-relaxed font-light">
              <p>
                مع قائمة طعام تضم أكثر من 100 طبق معد بعناية، يقدم كارديشلر جيهانكير رحلة شاملة عبر المطبخ التركي. ومع ذلك، فقد حققت بعض أصنافنا المميزة مكانة أسطورية بين ضيوفنا:
              </p>
              <ul className="space-y-3 pl-2 mt-4">
                <li className="flex gap-3">
                  <Star size={18} className="text-gold shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-cream block">كباب أضنة الكلاسيكي (Adana Kebab)</strong>
                    <span>أيقونتنا المطلقة. لحم غنم وبقر مفروم يدوياً، متبل بشكل مثالي برقائق الفلفل الأحمر ومشوي على سيخ عريض فوق جمر السنديان. يُقدم مع خبز اللافاش المخبوز على الحطب.</span>
                  </div>
                </li>
                <li className="flex gap-3">
                  <Star size={18} className="text-gold shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-cream block">فطائر البيدا بالفرن الحجري (Pide)</strong>
                    <span>تتوفر بأكثر من 15 نكهة، من اللحم المفروم الكلاسيكي (Kıymalı) إلى الأجبان المحلية الذائبة (Kaşarlı) واللحم المقدد التقليدي (Pastırmalı)، وتُخبز جميعها على بلاط حجري ساخن.</span>
                  </div>
                </li>
                <li className="flex gap-3">
                  <Star size={18} className="text-gold shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-cream block">كباب علي نازك (Ali Nazik)</strong>
                    <span>طعام عثماني ملكي شهي يتكون من قطع لحم ضأن طرية ومتبلة تقدم فوق طبقة مخملية من هريس الباذنجان المدخن المشوي على الفحم والممزوج بزبادي الثوم.</span>
                  </div>
                </li>
                <li className="flex gap-3">
                  <Star size={18} className="text-gold shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-cream block">اللحمجون المقرمش (Lahmacun)</strong>
                    <span>عجينة رقيقة ومقرمشة يعلوها مزيج مفروم ناعماً من اللحم والطماطم الطازجة والبصل والبقدونس، تُخبز في ثوانٍ معدودة في فرننا عالي الحرارة.</span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-cream leading-tight" style={{ fontFamily: "var(--font-cairo)" }}>
              قم بزيارتنا: طريقك إلينا من ميدان تقسيم
            </h2>
            <div className="space-y-4 text-cream-dim/85 text-sm sm:text-base leading-relaxed font-light">
              <p>
                قد يكون العثور على طعام أصيل وغير سياحي بالقرب من تقسيم أمراً صعباً، ولكن الوصول إلى كارديشلر جيهانكير سهل للغاية. نحن نقع على بعد 450 متراً فقط من ميدان تقسيم. المشي القصير والممتع لمدة 5 دقائق عبر "Defterdar Yokuşu" (باتجاه مسجد فيروزاغا التاريخي) سيقودك مباشرة إلى أبوابنا.
              </p>
              <div className="bg-[#140D07] p-5 rounded-xl border border-teal-dim/20 mt-4">
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span><strong>العنوان:</strong> Firuzağa Mah. Defterdar Yokuşu No:1/A, Cihangir, Beyoğlu, İstanbul</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Clock size={18} className="text-teal shrink-0" />
                    <span><strong>ساعات العمل:</strong> مفتوح يومياً من الساعة 09:00 صباحاً وحتى 02:00 بعد منتصف الليل</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Phone size={18} className="text-gold shrink-0" />
                    <span><strong>الحجوزات والتوصيل:</strong> +90 212 251 36 96</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <MessageCircle size={18} className="text-[#25D366] shrink-0" />
                    <span><strong>واتساب:</strong> +90 506 045 39 06</span>
                  </li>
                </ul>
              </div>
            </div>
