...
const restaurantSchema = {
  ...
  description: bt.heroDescription,
  url: siteUrl,
  telephone: RESTAURANT_INFO.phone,
  image: `${siteUrl}/images/Serpme-Kahvalti-2-Kisilik.webp`,
  servesCuisine: ["Turkish", "Breakfast", "Kebab"],
  priceRange: "₺₺",
  address: {
    "@type": "PostalAddress",
  ...
  sameAs: [RESTAURANT_INFO.instagram],
};

export default function ArabicBreakfastPage() {
  return (
    <>
