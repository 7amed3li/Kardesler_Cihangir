...
export const metadata = {
  ...
  openGraph: { title: bt.metaTitle, description: bt.metaDescription, url: `${siteUrl}/${locale}/${slug}`, siteName: RESTAURANT_INFO.name, locale: "it_IT", type: "website", images: [{ url: `${siteUrl}/images/Serpme-Kahvalti-2-Kisilik.webp`, width: 1024, height: 677, alt: bt.heroImageAlt }] },
...
export default function ItalianBreakfastPage() {
